...
BITFAM_res <- BITFAM(data = data_matrix_normalized, species = "human", interseted_TF = NA, scATAC_obj = NA, ncores = 10)
...
Annotation <- read.table(system.file("extdata", "liver_cell_type.txt", package = "BITFAM"), stringsAsFactors = F)
